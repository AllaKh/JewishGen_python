...
> **Про «одноразовость» — честно.** Офлайн-инсталлятор не может сам «сжечь» пароль после
> первой установки (для этого нужна онлайн-активация: сервер, который проверяет и гасит
> ключ — это отдельная большая фича). Поэтому «одноразовость» обеспечивается ТВОЕЙ схемой:
> новый пакет + новый пароль каждому человеку. Один пакет = один пароль для одного
> получателя. Если действительно нужен технический single-use — скажи, прикину серверную
> активацию отдельно.
